...
func NewGetSchedule(getter ScheduleGetter) http.HandlerFunc {
	return func(res http.ResponseWriter, req *http.Request) {
		...
		if err != nil {
			...
			slog.ErrorContext(ctx, "Get schedule: "+err.Error())
		...
		// Write json response
		schedule.Times = app.ConvertTimeToStr(schedule.TimesInt64)
		schedule.Status = "OK"
		...
		slog.InfoContext(ctx, "Schedule was successfully received")
	}
}
